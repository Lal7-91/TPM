...
## 🚀 Features
- 🔍 **Search Flights** — Fetch real-time flight information using Google Flights data  
- 🏨 **Find Hotels** — Get available hotels with prices and ratings from Google Hotels  
- 🌍 **Discover Attractions** — Suggest popular places and activities via TripAdvisor data  
- 🧠 **AI-Powered Analysis** — Summarize, compare, and recommend options through OpenAI models  
- 💻 **Interactive Dashboard** — Streamlit-based UI for easy navigation and visualization  
